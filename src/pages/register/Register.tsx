  ...
  return (
    <div className='container mx-auto'>
        ...
        <div className='flex gap-3 border dark:border-black dark:bg-slate-900 bg-white border-gray-200 w-96 h-12 mx-auto rounded-[12px] px-3 items-center mt-4'>
            <img src={photo} alt="" />
            <input type="tel" className='flex-1  outline-none text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 text-sm'  placeholder='+998 88 800-90-00' />
        </div>
